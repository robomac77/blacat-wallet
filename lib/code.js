...
(function (BlackCat) {
    class BuyExchangeView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            makeTransferObj.textContent = BlackCat.Main.langMgr.get("buy_exchange_pay_received");
