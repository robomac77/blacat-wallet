...
(function (BlackCat) {
    class PayExchangeRefundView extends BlackCat.ViewBase {
        ...
        doTransfer() {
            return __awaiter(this, void 0, void 0, function* () {
                if (!BlackCat.Main.viewMgr.payView.verifyAddr(this.inputTransferAddr.innerText)) {
                ...
                try {
                    ...
                    var res = yield BlackCat.tools.CoinTool.nep5Transaction(BlackCat.Main.user.info.wallet, destroy_addr, BlackCat.tools.CoinTool["id_" + transfer_type], this.inputTransferCount.value, net_fee);
                }
                catch (e) {
                    var res = new BlackCat.Result();
                    res.err = true;
    ...
    class PayExchangeShowWalletView extends BlackCat.ViewBase {
        ...
        create() {
            ...
            refundButton.onclick = () => {
                BlackCat.PayExchangeRefundView.refer = "";
                BlackCat.PayExchangeRefundView.callback_params = PayExchangeShowWalletView.callback_params;
                BlackCat.PayExchangeRefundView.balance = PayExchangeShowWalletView.balance;
                BlackCat.Main.viewMgr.change("PayExchangeRefundView");
            };
