...
namespace BlackCat {
    ...
    export class RefundView extends ViewBase {
        ...
        private netFeeCom: NetFeeNoSlide; // 手续费组件
        ...
        create() {
            ...
            popupTitle.innerText = Main.langMgr.get("refund_transfer") // "退款"
        ...
        toRefer() {
            if (RefundView.refer) {
                Main.viewMgr.change(RefundView.refer)
        ...
        private getAddress() {   // PayExchangeShowWalletView.address
            ...
            if (res) {
                ...
                if (res.err == false) {
                    ...
                    await ApiTool.addUserWalletLogs(
                        ...
                        "0",
                        net_fee,
                        RefundView.log_type_detail[this.transferType.toLowerCase()]
                    );
                    ...
                    this.remove();
                    if (RefundView.callback) RefundView.callback();
